...
from qd_glue.types import RNGKey

from qd_glue.tasks.kheperax.maze import Maze
from qd_glue.tasks.kheperax.rendering_tools import RenderingTools
from qd_glue.tasks.kheperax.robot import Robot
from qd_glue.tasks.kheperax.type_fixer_wrapper import TypeFixerWrapper
...
class KheperaxEnvironment(brax.envs.env.Env):
